...
| --- | ------------- | ----------------------------------------------------------------------------------------- |
| 1   | sponsor Data    | This table has details about Company/Organization/Individuals and bonds they bought.      |
| 2   | Receipient Data | This table has details about Political Parties and the bonds they received.               |
| 3   | sbi_Bank Data     | This table has the details about the bank branches where bonds can be issued or enchased. |
...
```bash 
EDA PYTHON
│   EDA_Electoral_bonds_data.ipynb
│ 
│
├───Data Cleaning
│       Data Cleaning.xlsx
...
- EDA_Electoral_bonds_data.ipynb is the file where the eda is accomplished using python and python libraries. 
